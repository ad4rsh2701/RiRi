...
// Respective Command Functions
     ...
     * @param args Parsed arguments of type: `span` of `RapidNode`: `{ {key, value}, {key2, value2}, ... }`
     ...
     */
    RIRI_API RiRi::Error::RiRiResult<std::string_view> setCommand(const std::span<RapidNode> args);

    //GET
    /**
     * @brief Retrieves the value(s) associated with one or more keys.
     * @param args Parsed arguments of type: `span` of `RapidNode`: `{ {key, ""}, {key2, ""} , ... }`
     ...
     *       The args vector only contains the remaining arguments.
     */
    RIRI_API RiRi::Error::RiRiResult<std::string_view> getCommand(const std::span<RapidNode> args);

    //UPDATE
    /**
     * @brief Updates existing key(s) with new value(s).
     * @param args args Parsed arguments of type: `span` of `RapidNode`: `{ {key, newValue}, {key2, newValue2}, ... }`
     ...
     *       The args vector only contains the remaining arguments.
     */
    RIRI_API RiRi::Error::RiRiResult<std::string_view> updateCommand(const std::span<RapidNode> args);
     ...
     *         The args vector only contains the remaining arguments.
     */
    RIRI_API RiRi::Error::RiRiResult<std::string_view> deleteCommand(const std::span<RapidNode> args);
     ...
     */
    RIRI_API RiRi::Error::RiRiResult<std::string_view> getAllCommand(const std::span<RapidNode> args);
     ...
     *         The args vector should be empty.
     */
    RIRI_API RiRi::Error::RiRiResult<std::string_view> clearCommand(const std::span<RapidNode> args);
     ...
     *
     * @param args Parsed arguments of type: `span` of `RapidNode`: `{ {<empty>, value}, {<empty>, value2}, ... }`
     ...
     */
    RIRI_API RiRi::Error::RiRiResult<std::string_view> autoSetCommand(const std::span<RapidNode> args);
     ...
     *         The args vector only contains the remaining arguments (values).
     */
    RIRI_API RiRi::Error::RiRiResult<std::string_view> searchCommand(const std::span<RapidNode> args);
